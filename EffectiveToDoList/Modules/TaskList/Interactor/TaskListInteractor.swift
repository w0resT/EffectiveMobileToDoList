...
class TaskListInteractor: TaskListInteractorProtocol {
    ...
    func fetchTasks() {
        ...
        tasks.append(Task(id: 3, title: "Почитать книгу", description: "Составить список необходимых продуктов для ужина. Не забыть проверить, что уже есть в холодильнике.", dateCreated: Date.now, isCompleted: false))
